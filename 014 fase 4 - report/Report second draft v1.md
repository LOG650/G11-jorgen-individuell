...
Takk til **SDK Shipping** for tilgang til 2020–2025-fakturadata og yacht­spesifikasjoner, og til *agency manager* for brukertesten i mai 2026 — funnene i § 9.5 hadde ikke vært mulige uten dialogen. Takk til foreleserne **Bjørn-Inge Pettersen** og **Per Kristian Rekdal** for kompendiet og veiledning; metodevalget er direkte forankret i deres rammeverk (§ 2.2 og § 5.0). Takk til Gruppe 10 for peer-review 2026-05-07 — innspill sporet og lukket i Vedlegg G.
