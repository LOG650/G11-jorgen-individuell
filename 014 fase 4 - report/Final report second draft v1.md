...
Denne rapporten er resultatet av et selvstendig prosjekt som har dratt nytte av flere bidragsytere. Først og fremst takk til **Yachting Operations** for å ha stilt 2020–2025-fakturadata og yacht­spesifikasjoner til disposisjon, og til *agency manager* som tok seg tid til brukertesten i mai 2026 — funnene i § 9.5 hadde ikke vært mulige uten denne dialogen. Videre takk til foreleserne **Bjørn-Inge Pettersen** og **Per Kristian Rekdal** for kompendiet *Kvantitative metoder i logistikk — implementert via KI* (2026) og for veiledning gjennom semesteret; metodevalget i NautiCost er direkte forankret i deres rammeverk (§ 2.2 og § 5.0). Takk også til medstudent i Gruppe 10 (Julie) for grundig peer-review 2026-05-07, hvis innspill er sporet og lukket i § 9.7.

Til slutt en åpen merknad om AI-bruk: deler av koden, figurene og rapport­teksten er utviklet i samarbeid med **Anthropic Claude** (Claude Code i terminal), i tråd med høgskolens retningslinjer om transparent KI-bruk. Alle resultat­tall er likevel verifisert mot kildedata og reproduserbare via skriptene i `013 fase 3 - review/`.
