...
> **Versjon 2.2 — 2026-05-25.** Andre utkast, andre revisjon. Endringer fra v1.1 oppsummert i Vedlegg G (peer-review og mentor-kontroll).

---

## Obligatorisk egenerklæring

**Forfatter:** Jørgen Rene · **Studiepoeng:** 15 (LOG650 Forskningsprosjekt) · **Veileder(e):** Bjørn-Inge Pettersen, Per Kristian Rekdal · **Dato:** 2026-05-25 · **Antall ord (hoved­tekst, Word-stil):** ca. 12 000.
...
Takk til **Yachting Operations** for tilgang til 2020–2025-fakturadata og yacht­spesifikasjoner, og til *agency manager* for brukertesten i mai 2026 — funnene i § 9.5 hadde ikke vært mulige uten dialogen. Takk til foreleserne **Bjørn-Inge Pettersen** og **Per Kristian Rekdal** for kompendiet og veiledning; metodevalget er direkte forankret i deres rammeverk (§ 2.2 og § 5.0). Takk til medstudent Julie (Gruppe 10) for peer-review 2026-05-07 — innspill sporet og lukket i Vedlegg G.
...
Studien er en case-studie (jf. kompendiets § B.4) i en konkret bedrift. Innenfor den rammen leveres tre **anvendte bidrag** — konkrete fremgangs­måter demonstrert på Yachting Operations sitt datasett, ikke generaliserte forsknings­funn:
...
Hver svakhet er ledsaget av et forsvar — bevisst valg, akseptert begrensning, eller åpent punkt for videre arbeid. Detaljert prosess­refleksjon ligger i Vedlegg G.
...
**Intern validitet** dreier seg om hvorvidt observerte sammenhenger i datasettet faktisk reflekterer kostnads­drivere snarere enn artefakter av prosessen. To trusler er sentrale: (i) *seleksjons­skjevhet* — alle 17 yachter er kunder hos én agentbedrift, og er dermed ikke et tilfeldig utvalg av skandinaviske superyacht-anløp; (ii) *historie* — tjeneste­miks-endringer eller leverandør­bytter over 2020–2025 kan ha generert tilsynelatende "tids­effekter" som egentlig er strukturelle prisbrudd. Trussel (i) adresseres ved eksplisitt avgrensning (§ 1.3) og ved at modellen ikke hevdes ekstern­validert på andre operatører. Trussel (ii) er adressert delvis ved tids­basert split (slik at trening og test ikke deler tids­vinduer der prisendringer kan ha skjedd samtidig), men siden detaljert data om leverandør­bytter ikke er tilgjengelig, kan det ikke utelukkes at en del av drift­en mellom val=2024 og test=2025 (+10 % MAE) skyldes en strukturell prisendring snarere enn naturlig generaliserings­tap.
...
En refleksjon over prosessens utfordringer — verktøy, KI-bruk, peer review-respons og iterativ forbedring — er flyttet til Vedlegg G for å holde hoved­teksten ren av meta-prat om gjennomføringen, jf. mentor-tilbakemelding ved kontroll­gjennomgangen 2026-05-25.
...
- **G.** Refleksjon over prosessens utfordringer — verktøy, KI-bruk, peer review-respons og iterativ forbedring (flyttet fra § 9.7 etter mentor-tilbakemelding ved kontroll­gjennomgangen 2026-05-25).
...
### Vedlegg G. Refleksjon over prosessens utfordringer

Flyttet hit fra § 9.7 i tidligere utkast etter mentor-tilbakemelding 2026-05-25 om at meta-prat om gjennomføring ikke hører i diskusjonskapittelet.

**Verktøy og KI-bruk.** Token-forbruket ble håndtert via parallelle Claude-sesjoner og Claude Code-worktrees. KI-hallusinerte referanser viste seg som reell risiko: Crossref-DOI-kontroll (v1.1) avdekket to oppføringer med korrekte DOI-er men fabrikerte forfatter­navn (Çerçi → Su 2024; Garrido → Jahangard 2025) — begge korrigert. DOI-resolusjon er nå standard sluttkontroll. Markdown → Word-konvertering håndteres av `convert_to_word_v2.py`. TreeSHAP-generering for Figur 7.6 feilet på `categorical_feature`-mismatch og falt tilbake til gain-importance som proxy (jf. § 7.3).

**Peer review-respons (G10/Julie, 2026-05-07).** Alle syv punktene er lukket gjennom v1.0–v2.2: konkretiserte bidrag i § 1.5, teori-relevans-bokser i § 3, eksplisitt skille utvikling/seleksjon/evaluering i § 5.4, PNG-figurer i § 7, litteratur­koblinger i diskusjonen, APA 7 og alfabetisk bibliografi (v2.1). Tre tilleggspunkter — test-sett-evaluering, statistisk signifikans, pensum­kobling — løst i v1.0 (`eval_test_2025.py`, bootstrap-KI, Pettersen & Rekdal). Bias-feil i Figur 7.8 (−0,03 → reell −0,20) er rettet i § 7.4.

**Mentor-kontroll (2026-05-25).** Seks endringer i v2.2: forside med egen­erklæring; «vi» → «jeg»/passiv; konkret KI-erklæring; § 1.5 om­formulert til *anvendte bidrag* jf. § B.4; refleksjon flyttet hit; refit-svakhet i § 8.1.1 tydeliggjort.

**Åpne strukturelle begrensninger:** produksjons­modellen mangler uavhengig holdout, operasjonell validering over tid, ekstern operatør­validitet, og Diebold-Mariano-test (videre arbeid 10–11). Alle eksplisitt dokumentert, ikke skjult — jf. A.3.
